...
import { FaBox, FaTools, FaCalculator, FaCheck, FaTimes, FaPlus, FaTrash, FaEdit, FaEye, FaFileAlt, FaUser, FaClock } from 'react-icons/fa';
...
const PartsEstimation = () => {
  ...
  const handleRejectEstimation = (id) => {
    if (window.confirm('Are you sure you want to reject this estimation?')) {
